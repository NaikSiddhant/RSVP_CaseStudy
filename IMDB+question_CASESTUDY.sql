...
SELECT COUNT(*) AS MovieRowCount FROM movie;     -- '7997'

-- Count the number of rows in the 'genre' table
SELECT COUNT(*) AS GenreRowCount FROM genre;     -- '14662'

-- Count the number of rows in the 'director_mapping' table
SELECT COUNT(*) AS DirectorMappingRowCount FROM director_mapping;    -- '3867'

-- Count the number of rows in the 'role_mapping' table
SELECT COUNT(*) AS RoleMappingRowCount FROM role_mapping;     -- '15615'

-- Count the number of rows in the 'names' table
SELECT COUNT(*) AS NamesRowCount FROM names;                   -- '25735'

-- Count the number of rows in the 'ratings' table
SELECT COUNT(*) AS RatingsRowCount FROM ratings;                -- '7997'
...
SELECT 
    COUNT(id) AS "Number of Movies in INDIA AND US in 2019 "
FROM
    movie
WHERE
    year = 2019
